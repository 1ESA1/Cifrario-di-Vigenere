...
var ASM_CONSTS = {
  92477: () => { if (document.fullscreenElement) return 1; },  
 92523: () => { return Module.canvas.width; },  
 92555: () => { return parseInt(Module.canvas.style.width); },  
 92603: () => { document.exitFullscreen(); },  
 92630: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 92702: () => { if (document.fullscreenElement) return 1; },  
 92748: () => { return Module.canvas.width; },  
 92780: () => { return screen.width; },  
 92805: () => { document.exitFullscreen(); },  
 92832: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 93026: () => { return window.innerWidth; },  
 93052: () => { return window.innerHeight; },  
 93079: () => { if (document.fullscreenElement) return 1; },  
 93125: () => { return Module.canvas.width; },  
 93157: () => { return parseInt(Module.canvas.style.width); },  
 93205: () => { if (document.fullscreenElement) return 1; },  
 93251: () => { return Module.canvas.width; },  
 93283: () => { return screen.width; },  
 93308: () => { return window.innerWidth; },  
 93334: () => { return window.innerHeight; },  
 93361: () => { if (document.fullscreenElement) return 1; },  
 93407: () => { return Module.canvas.width; },  
 93439: () => { return screen.width; },  
 93464: () => { document.exitFullscreen(); },  
 93491: () => { if (document.fullscreenElement) return 1; },  
 93537: () => { return Module.canvas.width; },  
 93569: () => { return parseInt(Module.canvas.style.width); },  
 93617: () => { document.exitFullscreen(); },  
 93644: ($0) => { Module.canvas.style.opacity = $0; },  
 93682: () => { return screen.width; },  
 93707: () => { return screen.height; },  
 93733: () => { return window.screenX; },  
 93760: () => { return window.screenY; },  
 93787: () => { return window.devicePixelRatio; },  
 93823: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 93876: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 93927: () => { Module.canvas.style.cursor = 'none'; },  
 93964: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 94220: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 94271: () => { if (document.pointerLockElement) return 1; },  
 94318: () => { if (document.fullscreenElement) return 1; },  
 94364: () => { return window.innerWidth; },  
 94390: () => { return window.innerHeight; }
};
