...
var ASM_CONSTS = {
  92509: () => { if (document.fullscreenElement) return 1; },  
 92555: () => { return Module.canvas.width; },  
 92587: () => { return parseInt(Module.canvas.style.width); },  
 92635: () => { document.exitFullscreen(); },  
 92662: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 92734: () => { if (document.fullscreenElement) return 1; },  
 92780: () => { return Module.canvas.width; },  
 92812: () => { return screen.width; },  
 92837: () => { document.exitFullscreen(); },  
 92864: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 93058: () => { return window.innerWidth; },  
 93084: () => { return window.innerHeight; },  
 93111: () => { if (document.fullscreenElement) return 1; },  
 93157: () => { return Module.canvas.width; },  
 93189: () => { return parseInt(Module.canvas.style.width); },  
 93237: () => { if (document.fullscreenElement) return 1; },  
 93283: () => { return Module.canvas.width; },  
 93315: () => { return screen.width; },  
 93340: () => { return window.innerWidth; },  
 93366: () => { return window.innerHeight; },  
 93393: () => { if (document.fullscreenElement) return 1; },  
 93439: () => { return Module.canvas.width; },  
 93471: () => { return screen.width; },  
 93496: () => { document.exitFullscreen(); },  
 93523: () => { if (document.fullscreenElement) return 1; },  
 93569: () => { return Module.canvas.width; },  
 93601: () => { return parseInt(Module.canvas.style.width); },  
 93649: () => { document.exitFullscreen(); },  
 93676: ($0) => { Module.canvas.style.opacity = $0; },  
 93714: () => { return screen.width; },  
 93739: () => { return screen.height; },  
 93765: () => { return window.screenX; },  
 93792: () => { return window.screenY; },  
 93819: () => { return window.devicePixelRatio; },  
 93855: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 93908: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 93959: () => { Module.canvas.style.cursor = 'none'; },  
 93996: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 94252: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 94303: () => { if (document.pointerLockElement) return 1; },  
 94350: () => { if (document.fullscreenElement) return 1; },  
 94396: () => { return window.innerWidth; },  
 94422: () => { return window.innerHeight; }
};
